...
@property (copy, nonatomic, readonly) NSString* universitiesUrl; // e.g. @"http://m.univmobile.fr"
...
@property (copy, nonatomic, readonly) NSString* shibbolethIdentityProvider;
