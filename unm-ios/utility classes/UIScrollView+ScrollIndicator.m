...
-(void) enableCustomVerticalScrollIndicator:(JMOScrollIndicatorPosition)vPos withColor:(UIColor *)indicatorColor withIndicatorStyle:(JMOScrollIndicatorType)style
{
    ...
    if (vPos == JMOVerticalScrollIndicatorPositionRight) {
        frame = CGRectMake(self.frame.size.width - width, 0.0f, JMOScrollIndicatorHeight,JMOScrollIndicatorWidth);
    }
    else {
...
//        viewScrollIndicator.layer.cornerRadius = width/2.0f;
        ...
        [viewScrollIndicator setBackgroundColor:[indicatorColor colorWithAlphaComponent:1]];
...
- (void)setIndicatorColor:(UIColor *)color {
    UIView *verticalIndicator = [self getViewForVerticalScrollIndicator];
    UIView *horizontalIndicator = [self getViewForHorizontalScrollIndicator];
    [verticalIndicator setBackgroundColor:[color colorWithAlphaComponent:1]];
    [horizontalIndicator setBackgroundColor:[color colorWithAlphaComponent:1]];
}
